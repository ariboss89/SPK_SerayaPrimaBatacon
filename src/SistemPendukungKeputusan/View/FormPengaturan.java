...
public class FormPengaturan extends javax.swing.JFrame {
    ...
    public FormPengaturan() {
       ...
       jTextField1.setText(tb_admin.getKeepUsername());
    }
    ...
    void CheckPassword(){
        ...
        try{
            ...
            rs = st.executeQuery("SELECT *FROM tb_admin WHERE username = '"+tb_admin.getKeepUsername()+"' AND password = '"+jPasswordLama.getText().trim()+"'");
            if(!rs.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        con = new Koneksi();
        if(jPasswordLama.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Silahkan Input Password Lama Anda !");
        }
        else if(jPasswordBaru.getText().equals("")){
        ...
        try{
            ...
            if(!rs.next()){
                ...
                pd.Update(jTextField1.getText(), jPasswordBaru.getText());
                dispose();
            }
        }catch(Exception e){
